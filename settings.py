...
# LOGGING
# ---------------------------------------------------------------------------
# Without this, Django's default logging config only emails ADMINS on a
# 500 (which isn't configured here) -- nothing is printed anywhere, which
# is exactly why the Render logs showed no traceback for the 500 error.
# This sends full tracebacks to stderr, which Render's Logs tab captures.
LOGGING = {
    "version": 1,
